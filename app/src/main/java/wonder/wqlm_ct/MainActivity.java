...
public class MainActivity extends AppCompatActivity {
    ...
    private void initObj() {
        cb_highSpeedMode = (CheckBox)(CheckBox)findViewById(R.id.cb_highSpeedMode);
        cb_notification = (CheckBox)findViewById(R.id.cb_notification);
        cb_accessibility = (CheckBox)findViewById(R.id.cb_accessibility);
        cb_getPacketSelf = (CheckBox)findViewById(R.id.cb_getPacketSelf);
        cb_usedDelayed = (CheckBox)findViewById(R.id.cb_usedDelayed);
        cb_usedRandomDelayed = (CheckBox)findViewById(R.id.cb_usedRandomDelayed);
        cb_useKeyWords = (CheckBox)findViewById(R.id.cb_usedKeyWords);
        et_delayedTime = (EditText)findViewById(R.id.et_delayedTime);
